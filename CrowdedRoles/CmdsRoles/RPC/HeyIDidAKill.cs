...
{
    [RegisterCustomRpc((uint)Rpc.CustomRpcCalls.HeyIDidAKill)]
    public class HeyIDidAKill : PlayerCustomRpc<RoleApiPlugin, HeyIDidAKill.Data>
    {
        public HeyIDidAKill(RoleApiPlugin plugin, uint id) : base(plugin, id)
        {
